...
/**
 * `TbMsgAttributesNodeTest` 测试类，用于验证 `TbMsgAttributesNode` 相关行为。
 */
@Slf4j
class TbMsgAttributesNodeTest extends AbstractRuleNodeUpgradeTest {
    ...
    /**
     * 功能：验证`Filter Changed Attr when Current Attributes Empty then Return New Attributes`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Filter Changed Attr when Current Attributes Contains In Any Order New Attributes then Return Empty List`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Filter Changed Attr when Current Attributes Contains In Any Order New Attributes then Return Expected List`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenNotifyDeviceMdValue_whenSaveAndNotify_thenVerifyExpectedArgumentForNotifyDeviceInSaveAndNotifyMethod` 描述的测试场景。
     * 参数：无。
     * 返回：处理结果。
     */
