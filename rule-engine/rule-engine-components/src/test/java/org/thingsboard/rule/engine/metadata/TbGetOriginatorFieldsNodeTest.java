...
/**
 * `TbGetOriginatorFieldsNodeTest` 测试类，用于验证 `TbGetOriginatorFieldsNode` 相关行为。
 */
...
public class TbGetOriginatorFieldsNodeTest {
    ...
    /**
     * 功能：验证 `givenValidMsgAndFetchToData_whenOnMsg_thenShouldTellSuccessAndFetchToData` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenDeviceWithEmptyLabel_whenOnMsg_thenShouldTellSuccessAndFetchToData` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenValidMsgAndFetchToMetaData_whenOnMsg_thenShouldTellSuccessAndFetchToMetaData` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenNullEntityFieldsAndIgnoreNullStringsFalse_whenOnMsg_thenShouldTellSuccessAndFetchNullField` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenEmptyFieldsMapping_whenInit_thenException` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenUnsupportedEntityType_whenOnMsg_thenShouldTellFailureWithSameMsg` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
