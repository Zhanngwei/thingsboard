...
/**
 * `TbGetTelemetryNodeTest` 测试类，用于验证 `TbGetTelemetryNode` 相关行为。
 */
public class TbGetTelemetryNodeTest {
    ...
    /**
     * 功能：验证 `givenAggregationAsString_whenParseAggregation_thenReturnEnum` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenAggregationWhiteSpace_whenParseAggregation_thenException` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenAggregationIncorrect_whenParseAggregation_thenException` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
