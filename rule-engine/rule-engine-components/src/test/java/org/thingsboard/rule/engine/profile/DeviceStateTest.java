...
/**
 * `DeviceStateTest` 测试类，用于验证 `DeviceState` 相关行为。
 */
public class DeviceStateTest {
    ...
    /**
     * 功能：验证 `whenAttributeIsDeleted_thenUnneededAlarmRulesAreNotReevaluated` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `whenDeletingClearedAlarm_thenNoError` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
