...
/**
 * `TbGetRelatedAttributeNodeTest` 测试类，用于验证 `TbGetRelatedAttributeNode` 相关行为。
 */
...
public class TbGetRelatedAttributeNodeTest {
    ...
    /**
     * 功能：验证 `givenDidNotFindEntity_whenOnMsg_thenShouldTellFailure` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenFetchFieldsToData_whenOnMsg_thenShouldFetchFieldsToData` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenFetchFieldsToMetadata_whenOnMsg_thenShouldFetchFieldsToMetadata` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
