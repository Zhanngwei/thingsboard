...
/**
 * `TbOriginatorTypeFilterNodeTest` 测试类，用于验证 `TbOriginatorTypeFilterNode` 相关行为。
 */
class TbOriginatorTypeFilterNodeTest {
    ...
    /**
     * 功能：验证 `givenDevice_whenOnMsg_then_True` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenAsset_whenOnMsg_then_False` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
...
/*
 * 本类总结：{@code TbOriginatorTypeFilterNodeTest} 为 {@code TbOriginatorTypeFilterNode} 的 过滤/分流节点 测试提供中文注释，说明测试目标、fixture 生命周期、Mock 来源和断言流程。
