...
/**
 * `TbRenameKeysNodeTest` 测试类，用于验证 `TbRenameKeysNode` 相关行为。
 */
public class TbRenameKeysNodeTest {
    ...
    /**
     * 功能：验证 `givenMsg_whenOnMsg_thenVerifyOutput` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenMetadata_whenOnMsg_thenVerifyOutput` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenMsgDataNotJSONObject_whenOnMsg_thenVerifyOutput` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
