...
public class TbMsgCountNode implements TbNode {
    ...
    /**
     * 字段说明：保存 `messagesProcessed`，表示与本类处理流程相关的运行时值，供本类方法在规则节点处理流程中使用。
     */
    ...
    /**
     * 字段说明：保存 `nextTickId`，表示与本类处理流程相关的运行时值，供本类方法在规则节点处理流程中使用。
     */
    private UUID nextTickId;
    /**
     * 字段说明：保存 `delay`，表示与本类处理流程相关的运行时值，供本类方法在规则节点处理流程中使用。
     */
    private long delay;
    /**
     * 字段说明：保存 `telemetryPrefix`，表示与本类处理流程相关的运行时值，供本类方法在规则节点处理流程中使用。
     */
    private String telemetryPrefix;
    /**
     * 字段说明：保存 `lastScheduledTs`，表示时间戳，供本类方法在规则节点处理流程中使用。
     */
    ...
    /**
     * 方法说明：执行 `scheduleTickMsg` 对应的辅助逻辑，供 `TbMsgCountNode` 的规则节点处理或辅助流程调用。
