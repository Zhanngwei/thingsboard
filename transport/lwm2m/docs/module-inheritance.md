# Thingsboard LwM2m Transport Service 模块继承体系分析
...
```mermaid
flowchart TD
    Object______p0["Object/外部框架"] -->|extends| ThingsboardLwm2mTransportApplication_c0["ThingsboardLwm2mTransportApplication"]
```
...
- `ThingsboardLwm2mTransportApplication.updateArguments()` (package, `transport/lwm2m/src/main/java/org/thingsboard/server/lwm2m/ThingsboardLwm2mTransportApplication.java`)
...
- `Object/外部框架` -> `ThingsboardLwm2mTransportApplication` (extends)
