# Thingsboard SNMP Transport Service 模块调用链分析
...
- Spring Boot 应用启动入口: `transport/snmp/src/main/java/org/thingsboard/server/snmp/ThingsboardSnmpTransportApplication.java`
- 命令行或进程启动入口: `transport/snmp/src/main/java/org/thingsboard/server/snmp/ThingsboardSnmpTransportApplication.java`
...
- `ThingsboardSnmpTransportApplication` (class, `transport/snmp/src/main/java/org/thingsboard/server/snmp/ThingsboardSnmpTransportApplication.java`)
