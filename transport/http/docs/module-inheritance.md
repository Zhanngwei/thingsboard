# Thingsboard HTTP Transport Service 模块继承体系分析
...
```mermaid
flowchart TD
    Object______p0["Object/外部框架"] -->|extends| ThingsboardHttpTransportApplication_c0["ThingsboardHttpTransportApplication"]
```
...
- `ThingsboardHttpTransportApplication.updateArguments()` (package, `transport/http/src/main/java/org/thingsboard/server/http/ThingsboardHttpTransportApplication.java`)
...
- `Object/外部框架` -> `ThingsboardHttpTransportApplication` (extends)
