# Thingsboard HTTP Transport Service 模块调用链分析
...
- Spring Boot 应用启动入口: `transport/http/src/main/java/org/thingsboard/server/http/ThingsboardHttpTransportApplication.java`
- 命令行或进程启动入口: `transport/http/src/main/java/org/thingsboard/server/http/ThingsboardHttpTransportApplication.java`
...
- `ThingsboardHttpTransportApplication` (class, `transport/http/src/main/java/org/thingsboard/server/http/ThingsboardHttpTransportApplication.java`)
