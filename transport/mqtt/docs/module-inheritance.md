# Thingsboard MQTT Transport Service 模块继承体系分析
...
```mermaid
flowchart TD
    Object______p0["Object/外部框架"] -->|extends| ThingsboardMqttTransportApplication_c0["ThingsboardMqttTransportApplication"]
```
...
- `ThingsboardMqttTransportApplication.updateArguments()` (package, `transport/mqtt/src/main/java/org/thingsboard/server/mqtt/ThingsboardMqttTransportApplication.java`)
...
- `Object/外部框架` -> `ThingsboardMqttTransportApplication` (extends)
