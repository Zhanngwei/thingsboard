# Thingsboard CoAP Transport Service 模块继承体系分析
...
```mermaid
flowchart TD
    Object______p0["Object/外部框架"] -->|extends| ThingsboardCoapTransportApplication_c0["ThingsboardCoapTransportApplication"]
```
...
- `ThingsboardCoapTransportApplication.updateArguments()` (package, `transport/coap/src/main/java/org/thingsboard/server/coap/ThingsboardCoapTransportApplication.java`)
...
- `Object/外部框架` -> `ThingsboardCoapTransportApplication` (extends)
