# Thingsboard CoAP Transport Service 模块调用链分析
...
- Spring Boot 应用启动入口: `transport/coap/src/main/java/org/thingsboard/server/coap/ThingsboardCoapTransportApplication.java`
- 命令行或进程启动入口: `transport/coap/src/main/java/org/thingsboard/server/coap/ThingsboardCoapTransportApplication.java`
...
- `ThingsboardCoapTransportApplication` (class, `transport/coap/src/main/java/org/thingsboard/server/coap/ThingsboardCoapTransportApplication.java`)
