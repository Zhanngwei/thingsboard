...
/**
 * 中文说明：
 * 1. `AssetProfileControllerTest` 是 ThingsBoard Application 中验证 `AssetProfileController` 相关行为的测试类型。
...
public class AssetProfileControllerTest extends AbstractControllerTest {
    ...
    /**
     * 功能：验证 `whenGetAssetProfileById_thenPermissionsAreChecked` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `whenGetAssetProfileInfoById_thenPermissionsAreChecked` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
