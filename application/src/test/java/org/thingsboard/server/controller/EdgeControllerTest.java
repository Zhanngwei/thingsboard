...
public class EdgeControllerTest extends AbstractControllerTest {
    ...
    /**
     * 功能：执行 `popAdminSettingsMsg` 对应的处理。
     * 参数：
     * - `messages`：待处理消息。
     * - `key`：键。
     * 返回：判断结果。
    ...
    /**
     * 功能：执行 `popDeviceProfileMsg` 对应的处理。
     * 参数：
     * - `messages`：待处理消息。
     * - `msgType`：待处理消息。
     * - `name`：名称。
    ...
    /**
     * 功能：执行 `popAssetProfileMsg` 对应的处理。
     * 参数：
     * - `messages`：待处理消息。
     * - `msgType`：待处理消息。
     * - `name`：名称。
    ...
    /**
     * 功能：执行 `popTenantProfileMsg` 对应的处理。
     * 参数：
     * - `messages`：待处理消息。
    ...
    /**
     * 功能：执行 `popSyncCompletedMsg` 对应的处理。
     * 参数：
     * - `messages`：待处理消息。
     * 返回：判断结果。
     */
