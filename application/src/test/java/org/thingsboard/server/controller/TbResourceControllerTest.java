...
public class TbResourceControllerTest extends AbstractControllerTest {
    ...
    /**
     * 功能：验证`Find Tb Resource By Id`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Download Tb Resource If Changed`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Get Lwm2m List Objects Page`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Get Lwm2m List Objects`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
