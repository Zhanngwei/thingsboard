...
public class BaseTbResourceServiceTest extends AbstractControllerTest {
    ...
    /**
     * 功能：验证`Max Resource Size Validation`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Save Lwm2m Tb Resource`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Save Tb Resource With Empty Title`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Save Lwm2m Tb Resource With XXE`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Find Resource By Id`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
