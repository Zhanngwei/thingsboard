...
/**
 * 中文说明：
 * 1. `AbstractRuleEngineFlowIntegrationTest` 是 ThingsBoard Application 中验证 `AbstractRuleEngineFlowIntegration` 相关行为的测试类型。
...
public abstract class AbstractRuleEngineFlowIntegrationTest extends AbstractRuleEngineControllerTest {
    ...
    /**
     * 功能：验证`Two Rule Chains With Two Rules`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
