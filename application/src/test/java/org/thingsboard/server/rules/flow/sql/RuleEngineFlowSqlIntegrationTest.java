...
/**
 * 中文说明：
 * 1. 类目的：`RuleEngineFlowSqlIntegrationTest` 是ThingsBoard Application 测试模块中的测试支撑类型，用于验证 Application 模块的控制器、服务、Actor 或集成流程。
...
/*
 * 本类总结：
 * 1. 核心职责：`RuleEngineFlowSqlIntegrationTest` 在 ThingsBoard Application 测试模块 中承担测试支撑类型职责，核心目的是验证 Application 模块的控制器、服务、Actor 或集成流程。
