...
/**
 * 中文说明：
 * 1. `QueueController` 是 ThingsBoard Application 中处理队列请求的 API 控制器。
...
public class QueueController extends BaseController {
     ...
     * 功能：获取租户。
     * 参数：
     * - `QUEUE_SERVICE_TYPE_DESCRIPTION`：服务对象。
     * - `QUEUE_SERVICE_TYPE_ALLOWABLE_VALUES`：服务对象。
     * - `serviceType`：服务对象。
