...
/**
 * 中文说明：
 * 1. `NumericFilterPredicate` 是 ThingsBoard Common Data 中承载 `Numeric Filter Predicate` 信息的数据类型。
...
public class NumericFilterPredicate implements SimpleKeyFilterPredicate<Double>  {
    ...
    /**
     * 中文说明：
     * 1. `NumericOperation` 是 ThingsBoard Common Data 中定义 `Numeric Operation` 固定取值的枚举类型。
