...
/**
 * 中文说明：
 * 1. `AbstractLwM2MBootstrapServerCredential` 是 ThingsBoard Common Data 中承载 LwM2M 信息的数据类型。
 * 2. 它把一次调用、消息传递或序列化所需的数据组织为明确结构。
 * 3. 字段分别表示该业务对象的标识、状态、内容或处理参数。
 * 4. 直接依赖的类型边界包括 `LwM2MServerSecurityConfig`、`LwM2MBootstrapServerCredential`。
