...
/**
 * 中文说明：
 * 1. `StringFilterPredicate` 是 ThingsBoard Common Data 中承载 `String Filter Predicate` 信息的数据类型。
...
public class StringFilterPredicate implements SimpleKeyFilterPredicate<String> {
    ...
    /**
     * 中文说明：
     * 1. `StringOperation` 是 ThingsBoard Common Data 中定义 `String Operation` 固定取值的枚举类型。
