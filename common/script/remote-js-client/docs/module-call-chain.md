# Thingsboard Server JS Client for remote JS execution 模块调用链分析
...
- Spring Component 组件入口: `common/script/remote-js-client/src/main/java/org/thingsboard/server/service/script/JsExecutorService.java`
- Spring Service 业务服务入口: `common/script/remote-js-client/src/main/java/org/thingsboard/server/service/script/RemoteJsInvokeService.java`
- 定时任务入口: `common/script/remote-js-client/src/main/java/org/thingsboard/server/service/script/RemoteJsInvokeService.java`
...
- `JsExecutorService` (class, `common/script/remote-js-client/src/main/java/org/thingsboard/server/service/script/JsExecutorService.java`)
- `RemoteJsInvokeService` (class, `common/script/remote-js-client/src/main/java/org/thingsboard/server/service/script/RemoteJsInvokeService.java`)
- `RemoteJsRequestEncoder` (class, `common/script/remote-js-client/src/main/java/org/thingsboard/server/service/script/RemoteJsRequestEncoder.java`)
- `RemoteJsResponseDecoder` (class, `common/script/remote-js-client/src/main/java/org/thingsboard/server/service/script/RemoteJsResponseDecoder.java`)
