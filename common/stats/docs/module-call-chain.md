# Thingsboard Server Stats 模块调用链分析
...
- Spring Service 业务服务入口: `common/stats/src/main/java/org/thingsboard/server/common/stats/DefaultStatsFactory.java`
- Spring Service 业务服务入口: `common/stats/src/main/java/org/thingsboard/server/common/stats/DefaultStatsFactory.java`
- Spring Service 业务服务入口: `common/stats/src/main/java/org/thingsboard/server/common/stats/FstStatsServiceImpl.java`
...
- rule_engine: 1 处静态触点；未发现直接源码证据；若发生，通常在依赖的下游模块中完成。
...
2. 模块入口：`stats` 通过入口类、依赖 API、构建聚合或子模块暴露能力。
...
- `DefaultCounter` (class, `common/stats/src/main/java/org/thingsboard/server/common/stats/DefaultCounter.java`)
- `DefaultMessagesStats` (class, `common/stats/src/main/java/org/thingsboard/server/common/stats/DefaultMessagesStats.java`)
- `DefaultStatsFactory` (class, `common/stats/src/main/java/org/thingsboard/server/common/stats/DefaultStatsFactory.java`)
- `StubCounter` (class, `common/stats/src/main/java/org/thingsboard/server/common/stats/DefaultStatsFactory.java`)
- `FstStatsServiceImpl` (class, `common/stats/src/main/java/org/thingsboard/server/common/stats/FstStatsServiceImpl.java`)
- `MessagesStats` (interface, `common/stats/src/main/java/org/thingsboard/server/common/stats/MessagesStats.java`)
- `StatsCounter` (class, `common/stats/src/main/java/org/thingsboard/server/common/stats/StatsCounter.java`)
- `StatsFactory` (interface, `common/stats/src/main/java/org/thingsboard/server/common/stats/StatsFactory.java`)
- `StatsType` (enum, `common/stats/src/main/java/org/thingsboard/server/common/stats/StatsType.java`)
- `TbApiUsageReportClient` (interface, `common/stats/src/main/java/org/thingsboard/server/common/stats/TbApiUsageReportClient.java`)
- `TbApiUsageStateClient` (interface, `common/stats/src/main/java/org/thingsboard/server/common/stats/TbApiUsageStateClient.java`)
