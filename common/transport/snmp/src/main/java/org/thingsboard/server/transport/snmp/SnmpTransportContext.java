...
/**
 * 中文说明：
 * 1. `SnmpTransportContext` 是 ThingsBoard Common Transport 中承载 SNMP 信息的数据类型。
...
public class SnmpTransportContext extends TransportContext {
    ...
    /**
     * 功能：获取`Devices And Establish Sessions`。
     * 参数：无。
     * 返回：无。
     */
    ...
    /**
     * 功能：执行 `establishDeviceSession` 对应的处理。
     * 参数：
     * - `device`：设备信息或设备标识。
     * 返回：无。
     */
     ...
     * 功能：保存或创建会话。
     * 参数：
     * - `deviceSessionContext`：设备信息或设备标识。
     * - `msg`：待处理消息。
     * 返回：无。
     */
