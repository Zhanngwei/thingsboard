...
public class EntityServiceRegistryTest extends AbstractServiceTest {
    ...
    /**
     * 功能：验证 `givenAllEntityTypes_whenGetServiceByEntityTypeCalled_thenAllBeansExists` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证 `givenRuleNodeEntityType_whenGetServiceByEntityTypeCalled_thenReturnedRuleChainService` 描述的测试场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
