...
/**
 * 中文说明：
 * 1. `OAuth2ServiceTest` 是 ThingsBoard DAO 中验证 `OAuth2Service` 相关行为的测试类型。
...
public class OAuth2ServiceTest extends AbstractServiceTest {
    ...
    /**
     * 功能：验证`Save Http And Mixed Domains Together`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Save Https And Mixed Domains Together`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Create And Find Params`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Clear Domain Params`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Update Clients Params`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Get O Auth2 Clients`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Get O Auth2 Clients For Http And Https`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Get Disabled O Auth2 Clients`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Find All Registrations`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Find Registration By Id`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：验证`Find Clients By Package And Platform`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
