...
public abstract class BaseTimeseriesServiceTest extends AbstractServiceTest {
    ...
    /**
     * 功能：验证`Find Latest Without Latest Update`相关场景。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：执行 `shouldSaveEntryOfEachType` 对应的处理。
     * 参数：无。
     * 返回：无。
     */
    @Test
    ...
    /**
     * 功能：保存或创建`Entries Without Latest`。
     * 参数：
     * - `deviceId`：设备IDID。
     * - `ts`：时间戳。
     * 返回：无。
