...
/**
 * 中文说明：
 * 1. `CassandraBaseTimeseriesDaoPartitioningMinutesAlwaysExistsTest` 是 ThingsBoard DAO 中验证 `CassandraBaseTimeseriesDaoPartitioningMinutesAlwaysExists` 相关行为的测试类型。
